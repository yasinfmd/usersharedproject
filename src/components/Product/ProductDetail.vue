<template>
    <div class="container" style="margin-top: -680px;padding-left: 100px">
        ...
        <p class="text-right" @click="deneme">İlanı Takip Et <input type="checkbox"  id="notificationswitch"    data-toggle="toggle" data-onstyle="outline-success"  data-on="Bildirimler Açık" data-off="Bildirimler Kapalı" data-offstyle="outline-danger" data-style="slow"></p>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">İlan Sahibi</a>
                        </div>
                    </div>
            <div class="col-8" >
